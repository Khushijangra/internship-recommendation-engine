...
export function Chatbot({ isOpen, onClose }: ChatbotProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: 'Welcome to Intern Setu Portal! 🇮🇳 I\'m your AI assistant here to help you navigate our government internship platform. I can guide you through:\n\n• Creating your profile\n• Finding perfect internship matches\n• Understanding the application process\n• Career development tips\n\nHow can I assist you today?',
      sender: 'bot',
      timestamp: new Date(),
    },
  ]);
      ...
      const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: `You are an AI assistant for the Intern Setu Portal, part of the Smart India Hackathon 2025 Government of India initiative to help students find relevant internships.

Your role is to:
1. Guide users through the internship application process on Intern Setu Portal
